...
import edu.csf.oop.java.schedule.logic.exceptions.WrongDayStringEntered;
...
public class TimeUtils {
    ...
    public static int dayOfWeekToNum (String dayOfWeek) throws WrongDayStringEntered {
        ...
        logger.error("ERROR: Wrong day as string in TimeUtils entered.");
        throw new WrongDayStringEntered();
    }
    public static String numOfDayToNameOfDay(int dayNum) throws WrongDayNumException {
        ...
        logger.error("ERROR: Wrong day num in TimeUtils entered.");
